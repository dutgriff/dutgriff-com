...
@section('content')
  ...
  <p>
    My name is Dustin Griffith. I am a freelance full stack software developer. I love to build things.
  </p>
  <p>
    This site will someday tell you just about everything you need to know about me and my work. It may be a while
    before I really get some stuff done here though. I work on it when I can but my clients obviously come first.
  </p>
  ...
  <div class="row container-inlay-container">
    <div class="col-xs-12 container-inlay inverse inverse-warning">
      ...
      <p>
        ...
        I am getting there. Once I get something going here I will work out the bugs and start leaving the development
  ...
  <dl class="dl-horizontal">
    ...
    <dd>
      ...
      doing wrong in development, a workflow that works great for me or just a rant or interest, I
    ...
    <dd>
      <b>Demo is up!</b><br/>
      My <s>AngularJS</s> Vue.js time tracker. This is how I log my hours. It will allow users with a 'client'
  ...
  <p>
    <b>Update: I have been really busy lately so please email as soon as possible to lock in your spot on my calendat.</b>
  ...
  <div class="row">
    <div class="col-md-11 col-md-offset-1">
      ...
      at my computer either studying or programming. I consider myself very resourceful and self sufficient.<br/>
